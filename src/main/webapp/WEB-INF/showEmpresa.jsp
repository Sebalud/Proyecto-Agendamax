            ...
            <button class="btn botones" type="submit">Buscar</button>
                ...
                <div class="container d-flex my-5">
                    ...
                    <div id="ladoCarrusel" class="ml-5">
                        ...
                        <p>Aquí podras configurar y visualizar los servicios que ofrece tu empresa, revisar el
                        ...
                        <div class="modal fade " id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="background-color: #1D2226; color: aliceblue;">
                                    ...
                                    <div class="modal-body">
                                        ¿Estás seguro/a de que quieres eliminar tu empresa?
                                    </div>
                                    <div class="modal-footer">
                                            ...
                                            <div class="modal-body d-flex">
                                                ...
                                                <div class="text-box ms-3 mt-5">
                                                    ...
                                                    <div id="botonesModal" class="text-center mt-4">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                        <a class="btn btn-primary" id="haztePremium" href="/premium/${empresa.id}">Házte premium</a>
                                                    </div>
                                                    </div>
