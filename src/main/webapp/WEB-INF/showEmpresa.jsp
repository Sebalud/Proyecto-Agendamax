    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Poner info de las caracteristicas de la empresa, cuales son los derechos y
                                            deberes del
                                            propietario
                                        </div>
            ...
            <form class="d-flex" role="search" method="POST" action="/search" id="barrita">
                ...
                <input class="form-control me-2" type="search" name="servicio" placeholder="Inserte servicio"
                    aria-label="Search">
...
<div class="container d-flex my-5">
    ...
    <div id="ladoCarrusel" class="ml-5">
        ...
        <!-- Eliminar Empresa -->
        <button type="button" class="btn botones " data-bs-toggle="modal" data-bs-target="#exampleModal4">
            Eliminar Empresa
        </button>
        ...
        <a class="btn botones " href="/plan/${empresa.id}/edit">Edita Tu Empresa</a>
    </div>
</div>
        ...
        <c:choose>
                        ...
                        <div class="form-items">
                            ...
                            <form:form action="" method="POST" modelAttribute="servicio" cssClass="container form ancho"
                                ...
                                <div class="form-button mt-3">
                                    <input id="submit" class="btn btn-primary" type="submit" value="Crear" />
                                </div>
                            </form:form>
                        </div>
                    </div>
            ...
            <c:when test="${empresa.servicios.size() == 1 && empresa.empresafree}">
                <h1 id="infoPremium" class="my-auto mx-auto">
                    ¿Pensando en que tu empresa ofrezca otro servicio?<span class="letraDif fw-bold"> Hazte premium
                        ahora</span>
                </h1>
                <button type="button" class="btn btn-danger mx-auto my-auto" id="botonPremium" data-bs-toggle="modal"
                        ...
                        <div class="modal-content">
                            <div class="modal-body d-flex">
                                ...
                                <div class="text-box ms-3 mt-5">
                                    <h2 class="fw-semibold mt-3">Ofrece más de un servicio y disfruta de otras ventajas
                                        con Premium</h2>
                                    <p class="font-md">Suscríbete desde 7.50/EUR/mes y accede a:</p>
                                    <div class="feature"><i class="fa-duotone fa-check"></i>
                                        <p class="font-sm mg-bottom-lv1">8.9M iconos y stickers en formato SVG, EPS, PSD
                                            y BASE64</p>
                                    </div>
                                    <div class="feature"><i class="fa-duotone fa-check"></i>
                                        <p class="font-sm mg-bottom-lv1">posibilidad de ofrecer hasta 10 servicios al
                                            mismo tiempo</p>
                                    </div>

                                    <div class="feature"><i class="fa-duotone fa-check"></i></i>
                                        <p class="font-sm mg-bottom-lv1">Soporte prioritario</p>
                                    </div>
                                    <div class="feature"><i class="fa-duotone fa-check"></i>
                                        <p class="font-sm mg-bottom-lv3">Sin publicidad</p>
                                    </div>
                                    <div id="botonesModal" class="text-center mt-4">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Cancelar</button>
                                        <a class="btn btn-primary" id="haztePremium" href="/premium/${empresa.id}">Hazte
                                            premium</a>
                                    </div>
                                </div>
                            </div>
